...
/* harmony import */ var _layout_colors_colors_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./layout/colors/colors.component */ "./src/app/layout/colors/colors.component.ts");




const routes = [{ path: "", component: _layout_colors_colors_component__WEBPACK_IMPORTED_MODULE_3__["ColorsComponent"] }];
...
/* harmony import */ var _layout_nav_nav_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./layout/nav/nav.component */ "./src/app/layout/nav/nav.component.ts");
...
/* harmony import */ var _layout_colors_colors_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./layout/colors/colors.component */ "./src/app/layout/colors/colors.component.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _data_api_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./data/api.service */ "./src/app/data/api.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _layout_colors_colors_component__WEBPACK_IMPORTED_MODULE_8__["ColorsComponent"],
            _layout_colors_colors_component__WEBPACK_IMPORTED_MODULE_8__["HexDialogComponent"],
        ],
        imports: [
...
let ApiService = class ApiService {
    ...
    getInitialPalettes() {
        return this.http.get(`${this.apiUrl}hex=${this.defaultColors[Math.floor(Math.random() * this.defaultColors.length)]}&mode=analogic&count=5`);
    }
    getPalettes(value, userMode) {
        return this.http.get(`${this.apiUrl}hex=${value}&mode=${userMode}&count=5`);
    }
};
...
/* harmony import */ var src_app_data_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/data/api.service */ "./src/app/data/api.service.ts");
...
let ColorsComponent = class ColorsComponent {
    constructor(apiService, dialog) {
        ...
        this.colorModes = ["monochrome", "analogic", "complement"];
    ...
    getPalettes() {
        this.apiService.getInitialPalettes().subscribe((data) => {
            this.data = data.colors;
            console.log(this.data);
        }, (err) => console.error(err), () => console.log("done loading palette"));
    }
    ...
    getUserPalette(hexValue, mode) {
        this.apiService.getPalettes(hexValue, mode).subscribe((data) => {
            this.data = data.colors;
            console.log(this.data);
        }, (err) => console.error(err), () => console.log("done loading user palette"));
    }
...
ColorsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-colors",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./colors.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/colors/colors.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./colors.component.scss */ "./src/app/layout/colors/colors.component.scss")).default]
    })
], ColorsComponent);

//Dialog for source colors
let HexDialogComponent = class HexDialogComponent {
...
HexDialogComponent.ctorParameters = () => [
...
HexDialogComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "hex-dialog",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./hex-dialog/hex-dialog.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/colors/hex-dialog/hex-dialog.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./hex-dialog/hex-dialog.component.scss */ "./src/app/layout/colors/hex-dialog/hex-dialog.component.scss")).default]
    }),
...
NavComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-nav",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./nav.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/nav/nav.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./nav.component.scss */ "./src/app/layout/nav/nav.component.scss")).default]
    })
], NavComponent);
